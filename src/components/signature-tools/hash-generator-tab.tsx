...
import { Lock, CheckCircle, Shield, RefreshCw, FileDigit, FileCheck, Loader2, AlertTriangle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-opacity-95 text-gray-200 p-6 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-3xl">
        ...
        <div className="flex justify-between bg-gray-800 bg-opacity-50 backdrop-blur-sm mb-6 p-1 rounded-lg text-sm">
          <button
            className={`flex-1 px-3 py-2 flex items-center justify-center space-x-2 ${activeTab === 'Sign Message' ? 'bg-purple-600 bg-opacity-30' : 'bg-transparent'}`}
          ...
          <button
            className={`flex-1 px-3 py-2 flex items-center justify-center space-x-2 ${activeTab === 'Verify Signature' ? 'bg-purple-600 bg-opacity-30' : 'bg-transparent'}`}
          ...
          <button
            className={`flex-1 px-3 py-2 flex items-center justify-center space-x-2 ${activeTab === 'Proof of Ownership' ? 'bg-purple-600 bg-opacity-30' : 'bg-transparent'}`}
          ...
          <button
            className={`flex-1 px-3 py-2 flex items-center justify-center space-x-2 transition-colors ${activeTab === 'Hash Generator' ? 'bg-purple-600 bg-opacity-30' : 'bg-transparent hover:bg-gray-700/50'}`}
        ...
        {activeTab === 'Hash Generator' && (
          <>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg shadow-lg p-6 mb-6">
              ...
              <div className="mb-4">
                <label htmlFor="hash-algorithm" className="block text-sm font-medium mb-2">Hash Algorithm</label>
              ...
              {generatedHash && (
                <div className="mb-6">
                  <label className="block text-sm font-medium mb-2">Generated Hash</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-800 rounded-lg shadow-lg p-4">
                ...
                <p className="text-sm text-gray-400">
                  Our tools are compatible with major blockchain standards including Ethereum (Keccak-256), Bitcoin (SHA-256), and more.
                </p>
              </div>
              ...
              <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-800 rounded-lg shadow-lg p-4">
                ...
                <p className="text-sm text-gray-400">
                  From simple messages to complex transactions, verify signatures and prove ownership of blockchain assets using cryptographic hashes.
                </p>
              </div>
            </div>
          </>
