...
export function CreateWalletButton({ onClick, isCreating, size = "default", className = "" }: CreateWalletButtonProps) {
      ...
      >
        {isCreating ? (
          <div className="flex items-center gap-2">
            ...
            <span>{size === "large" ? "Creating Wallet..." : "Creating..."}</span>
          </div>
        ) : (
          <div className="flex items-center gap-2">
            <span>{size === "large" ? "GET STARTED NOW" : "CREATE WALLET"}</span>
